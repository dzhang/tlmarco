...
def setWeights(layers, weights):
	for index, layer in enumerate(layers):
		...
		print(str(index) + ", " + layer.name + " weights have been set!")
...
if __name__ == "__main__":
	model = marco.create_model()    # weights=None, no weights loaded
	...
	model.save_weights("../weights/marco_weights_tf_dim_ordering_tf_kernels_notop.h5")
